...
def yek():
    ...
    umah = '[FBAN/FB4A;FBAV/267.1.0.46.120;FBBV/210653414;FBDM/{density=2.0,width=720,height=1402};FBLC/en_US;FBRV/211387411;FBCR/ ;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S102DL;FBSV/9;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
    xuna = sex+umah
...
def Main():
        try:
                        clear();print(f"\x1b[38;5;46m➤{A} TOKEN {R}:{G} {kex}");linex()
                        ...
                        if samar in ['1','01']:
                                clear();print(f'\x1b[38;5;46m➤{A} EXAMPLE {R}: {G}/sdcard/ronaldo.txt ');linex()
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        try:
                                                ...
                                                ps_limit =1
                                        clear()
                                        print(f'\x1b[38;5;46m➤{A} EXAMPLE \033[1;32m: \033[1;31mfirstlast/first@123/first123 ')
                                        linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f"\x1b[38;5;46m➤{A} TOKEN {R}:{G} {kex}");linex();print(f'\x1b[38;5;46m➤{A} CRACKING METHOD {R}:{G} M{mthd}')
